...
| "We have an AI use case and I cannot connect it to a business result" | [`business-initiative-coach`](skills/business-initiative-coach/) | A result someone owns, the constraint it attacks, who has to behave differently, and a belief stated so it could turn out false |
...
| "Things ship and nobody can tell me whether anyone actually uses them" | [`extending-kanban-from-output-to-outcome`](skills/extending-kanban-from-output-to-outcome/) | One lane after Released with criteria you can check, the altitude that can hold it, and what the work you already closed as Done turns out to be hiding |
...
| "Agents do work that used to need a team, and I don't know which of our scaled ways of working still earn their keep" | [`scaled-agile-for-agentic-sdlc`](skills/scaled-agile-for-agentic-sdlc/) | Which mechanisms lost the problem they were bought for, whether judgment belongs in the flow or on a cadence, and one experiment against the weakest one |
